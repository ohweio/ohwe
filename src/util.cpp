...
const char * const BITCOIN_CONF_FILENAME = "ohwecoin.conf";
const char * const BITCOIN_PID_FILENAME = "ohwecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ohwecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ohwecoin";
#else
    // Unix
    return pathRet / ".ohwecoin";
#endif
#endif
}
