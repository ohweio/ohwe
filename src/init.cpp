...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ohwecoin-project/ohwecoin>";
    const std::string URL_WEBSITE = "<https://ohwecoin.org>";
