...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ohwecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ohwecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ohwecoin transaction") + "\n" +
              "  ohwecoin-tx [options] -create [commands]   " + _("Create hex-encoded ohwecoin transaction") + "\n" +
              "\n";
