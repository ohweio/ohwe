...
void RPCNestedTests::rpcNestedTests()
{
    ...
    ClearDatadirCache();
    std::string path = QDir::tempPath().toStdString() + "/" + strprintf("test_ohwecoin_qt_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
    ...
    QVERIFY(result == "090f35b7ce76ff8b8733dd0c60fa0f81f4541c4acbb9c9ddf6261a5cb02bd1e5");
